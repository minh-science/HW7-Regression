...
def main():
    ...
    log_model = logreg.LogisticRegressor(num_feats=6, learning_rate=0.01, tol=0.0001, max_iter=1000, batch_size=10) # suggeted hyperparameters (num_feats=6, learning_rate=0.1, tol=0.01, max_iter=100, batch_size=10)
    # learning rate is one of the most importnat one! 
